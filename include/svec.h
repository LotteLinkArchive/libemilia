...
#define __hh_dyn_push(a, v)    ({hh_stat_t __99tmp = __hh_dyn_add((a), 1); if (__99tmp == HH_STATUS_OKAY)\
                               (a)[__hh_dyn_last_idx((a))] = (v); __99tmp;})
...
#define __hh_dyn_ins(a, i, v)  ({__hh_dyn_init((a)); __typeof__((a)[0]) __96tmp = (v);\
...
#define __hh_dyn_pushtt(a, v)  ({hh_stat_t __99tmp = __hh_dyn_add((a), 1); if (__99tmp == HH_STATUS_OKAY)\
                               (__hh_i_dyn_ecl((a), __typeof__((v)))) = (v); __99tmp;})
